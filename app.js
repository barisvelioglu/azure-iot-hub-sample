...
const deviceConnectionString = "HostName=LunchLearn.azure-devices.net;DeviceId=device61;SharedAccessKey=aVGhRqxhCm1gZdfxQNvLCn2S4BBTZkE8p3PBz8FKEGo=";
let sendInterval;
...
function generateMessage () {
  ...
  const temperature = 30 + (Math.random() * 10); // range: [20, 30]
  ...
  message.properties.add('temperature', temperature);
  return message;
}
